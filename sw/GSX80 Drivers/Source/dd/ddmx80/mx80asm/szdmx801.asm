h62293
s 00385/00000/00000
d D 1.1 83/03/17 15:59:49 tes 1 0
c date and time created 83/03/17 15:59:49 by tes
e
u
4
U
...
; ****************************************************************************
;                                                                            *
;    REVISION : Dec. 06, 1982   FILE "ZDMX801.ASM"    Version 1.0            *
;                                                                            *
;***** MODE NOTES :  *********************************************************
;                                                                            *
...
;      6) Send 7 Bit Byte count to the Stupid Printer                        *
;                                                                            *
;***** MODE NOTES :  *********************************************************
;                                                                            *
...
YSIZE    DS     02           ;No. of vertical Pixels per Print Line
                             ;PLINE * PIXL
BWIDE    DS     02           ;XW * 8 = NO. OF GRAPHIC BYTES PER LINE
EPSON1   DS     02           ;BYTE COUNT PER PASS <= 120 BYTES
...
;         esc A 07  - Set linefeed to 7 pixels
         ...
         MVI    A,     ESC
         CALL   POUT
         MVI    A,     41H       ;Set Line Spacing at 7/72 inches
         CALL   POUT             ;ESC A 07
         MVI    A,     07
         CALL   POUT
...
;        number of pixels is 8*xw
         ...
         SHLD   BWIDE           ; Store XW * 8 = NO. OF GRAPHIC BYTES PER
                                ; LINE
         RET
...
GENTER
         ...
         MVI    A,     4BH
         CALL   POUT
         LDA    EPSON1           ;No. of Bytes sending to Epson as Graphic
         CALL   POUT             ;Bytes
         XRA    A                ;Flag, 0 = sending LESS THEN 127 BYTES
         CALL   POUT
         RET
