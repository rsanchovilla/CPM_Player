/* PROF - Profile library and print routines for C/80.
   ...
   To generate version which uses in-memory clock, remove /* at beginning
	of following line, change the definition of TICCNT to the memory
	address of the system clock, and recompile by "c -l32600 cprof"
	(omit the -l for M80 compatibility). */

#define CPM 0			/* Defined for CP/M, undefined for HDOS */
...
#asm
; CPROF - C/80 Execution Profile (2/26/82)
