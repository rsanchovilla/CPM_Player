/*	ccopt.c
	...
	Copyright (c) 2000-2015 Miguel I. Garcia Lopez, FloppySoftware.
	...
	19 Mar 2001 : v0.20
	16 Apr 2007 : GPL'd.
	17 Jul 2015 : v1.01 : Now uses remove() and rename(), instead of del_file() and ren_file().
	                      Modified some messages.
	03 Sep 2015 : v1.02 : Incremented max. # of labels to 2000 for pass2() -- it was 1000.
	04 Sep 2015 : v1.03 : Added some comments, modified some messages.

	Notes:

	Option -t is to set a temporary drive (a RAM drive, for example) - ie: -tm:
*/
...
int argc, argv[];
{
	...
	printf("Mike's Enhanced Small C Compiler Optimizer v1.03 - 04 Sep 2015\n\n");
	printf("(c) 2000-2015 FloppySoftware\n\n");

	if(argc==1)
	{
		printf("Usage: ccopt fname.typ [-td:]\n"); return;
	}
