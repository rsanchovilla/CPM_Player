1 REM *** FOR DOS 4 AND 5 WHICH WAS LOADED AT 2000H LEAVING *** 
2 REM *** 0000-1FFF EMPTY - CAREFUL, ANY DOS AT 0100 WILL BE **
3 REM *** OVERWRITTEN.                                      *** 
4 DIM V$(1)
5 ! CHR$(2)
10 !"         'TINY' PASCAL COMPILER FOR P-MACHINE"
11 FOR X=1TO8\!\NEXT
12 FOR X=1 TO 400\FILL 65000,255\NEXT
20 ! CHR$(2)
21 INPUT"             CLEAR P-CODE AREA? ",V$
22 IF V$<>"Y"THEN 30
23 ! CHR$(2)
24 !"               CLEARING P-CODE AREA (0000-19FF)"
25 !"                     (TAKES 30 SECONDS)"
26 FOR X=1TO6\!\NEXT
28 FOR X=0TO6655\FILL X,255\NEXT
30 ! CHR$(2)
40 N0=32
50 T0=50
60 N1=32767
...
332 L9=INT((P9+1)/256)+1
334 !\!"   PSIZE OF P-CODES:",L9," BLOCKS"\!
340 INPUT " INTERPRET (I) OR TRANSLATE (T)? ",Y$
350 IF Y$=""THEN END
360 IF Y$<>"I"THEN 370
362 INPUT" IS INTERPRETER LOADED? ",V$
364 IF V$<>"Y" THEN M0=CALL(8232)
366 M0=CALL(40960)
370 IF Y$="T"THEN CHAIN "PASTRANS"
380 END
390REM ***************
